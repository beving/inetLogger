...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "iLogger@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "iLogger API";

        private String description = "iLogger API documentation";
